package cc.dagger.photopicker.demo.imagloader;
...
import cc.dagger.photopicker.demo.DemoApplication;
import cc.dagger.photopicker.demo.R;
...
public class FrescoImageLoader extends PhotoPickerImageLoader<SimpleDraweeView, PhotoDraweeView> {
    ...
    public FrescoImageLoader() {
        ...
        ImagePipelineConfig imagePipelineConfig = ImagePipelineConfig.newBuilder(DemoApplication.getInstance())
                .setBitmapsConfig(Bitmap.Config.RGB_565)
                .setDownsampleEnabled(true)
                .build();
        Fresco.initialize(DemoApplication.getInstance(), imagePipelineConfig);
    }
