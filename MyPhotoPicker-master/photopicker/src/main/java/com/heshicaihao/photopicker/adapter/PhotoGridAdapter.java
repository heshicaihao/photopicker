package com.heshicaihao.photopicker.adapter;
...
import com.heshicaihao.photopicker.PhotoPickerImageLoader;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            if(showSelectIndicator){
                holder.indicator.setImageResource(selected ? R.mipmap.btn_selected
                        : R.mipmap.btn_unselected);
            }
            // 显示图片
            if(imageLoader != null) {
